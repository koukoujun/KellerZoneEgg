/*
 ...
 Source Server         : keller_zone
 Source Server Type    : MySQL
 Source Server Version : 50726
 Source Host           : localhost:3306
 Source Schema         : keller_zone

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 09/02/2021 17:53:53
*/
...
-- ----------------------------
-- Table structure for community_list
-- ----------------------------
...
CREATE TABLE `community_list`  (
  ...
  `praise_count` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `is_parise` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `read_count` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `is_focus` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of community_list
-- ----------------------------
INSERT INTO `community_list` VALUES (1, NULL, '阅读', '使用Lint工具“武装”你的项目', '4', NULL, NULL, '<p>通过静态检查工具来规范自己项目的代码，让团队所有成员保持一致的编码风格，这样大家可以专注于核心特性的开发，提升整体开发效率。</p><p>以下将对DevUI组件库使用的各种lint工具进行介绍，并说明如何在代码提交阶段进行统一格式检查与修正。</p><p>通过阅读这篇指南，希望你也可以使用这些Lint工具来“武装”自己的项目。</p><p>DevUI组件库lint一致性主要使用以下工具保证：</p><p><br></p><ul><li>prettier</li><li>tslint</li><li>stylelint</li><li>commitlint</li></ul><p>在开始前，你可在项目目录下新建各lint配置文件：</p><p><br></p><pre class=\"ql-syntax\" spellcheck=\"false\">/YourProject\n├── ...\n├── .prettierrc\n├── tslint.json\n├── .stylelintrc.json\n├── .vscode\n|  ├── extensions.json\n|  └── settings.json\n└── commitlint.config.js\n</pre><h1>1 文件基本格式约束 - prettier</h1><p>Prettier的中文意思是“漂亮的、机灵的”，也是一个流行的代码格式化工具的名称，它能够解析代码，使用你自己设定的规则来重新打印出格式规范的代码。</p><p>Prettier具有以下几个有优点：</p><p><br></p><ol><li>可配置化</li><li>支持多种语言</li><li>集成多数的编辑器</li><li>简洁的配置项</li></ol><p>使用Prettier在code review时不需要再讨论代码样式，节省了时间与精力。</p><p>安装prettier：</p><p><br></p><pre class=\"ql-syntax\" spellcheck=\"false\">npm i -D prettier\n复制代码\n</pre><p>配置<code>.prettierrc</code>文件。</p><p><a href=\"https://prettier.io/docs/en/options.html\" rel=\"noopener noreferrer\" target=\"_blank\">prettier配置参考</a></p><p><br></p><pre class=\"ql-syntax\" spellcheck=\"false\">// 注释为对对应规则注释，复制到项目中可删除\n{\n  \"tabWidth\": 2, // 设定每个缩进为2个空格\n  \"semi\": true, // 在语句末尾添加分号\n  \"singleQuote\": true, // 使用单引号\n  \"jsxSingleQuote\": true,\n  \"bracketSpacing\": true, // 在括号间打印空格\n  \"jsxBracketSameLine\": true, // 把多行\'&gt;\'放在最后一行的末尾，而不是另起一行放置\n  \"printWidth\":140, // 行长超过140将会换行\n  \"endOfLine\": \"auto\",\n  \"proseWrap\": \"preserve\",\n  \"trailingComma\": \"es5\",\n  \"useTabs\": false\n}\n</pre><p><br></p>', NULL, '测试员', NULL, '2020-12-31 16:58:29');
INSERT INTO `community_list` VALUES (2, NULL, '阅读', '测试02', '4', NULL, NULL, '<p>测试02内容</p>', NULL, '测试员', NULL, '2021-01-11 11:32:25');
INSERT INTO `community_list` VALUES (3, NULL, '阅读', '测试03', '0', NULL, NULL, '<p>daadw</p>', NULL, '测试员', NULL, '2021-01-11 11:33:25');
INSERT INTO `community_list` VALUES (4, '20210107162750874691', '阅读', '今天11号', '0', NULL, NULL, '<p>啊啊</p>', NULL, '测试员', NULL, '2021-01-11 11:35:37');
INSERT INTO `community_list` VALUES (5, '20210107162750874691', '阅读', '啊', '1', NULL, NULL, '<p>啊啊</p>', NULL, '游客0.1504号', NULL, '2021-01-11 11:49:30');
INSERT INTO `community_list` VALUES (6, '20210107162750874691', '阅读', '', '0', NULL, NULL, '', NULL, '座头鲸', NULL, '2021-01-14 17:42:07');
INSERT INTO `community_list` VALUES (7, '20210107162750874691', '阅读', '', '0', NULL, NULL, '', NULL, '座头鲸', NULL, '2021-01-14 17:46:51');
INSERT INTO `community_list` VALUES (8, '20210107162750874691', '阅读', '', '0', NULL, NULL, '', NULL, '座头鲸', NULL, '2021-01-14 17:51:33');
INSERT INTO `community_list` VALUES (9, '20210107162750874691', '阅读', '222', '0', NULL, NULL, '<p>2222222222222222</p>', NULL, '座头鲸', NULL, '2021-01-14 18:06:30');
INSERT INTO `community_list` VALUES (10, '20210107162750874691', NULL, '2', '0', NULL, NULL, '<p>2</p>', NULL, '座头鲸', NULL, '2021-02-08 16:20:56');

-- ----------------------------
-- Table structure for community_response
-- ----------------------------
DROP TABLE IF EXISTS `community_response`;
CREATE TABLE `community_response`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `pid` int(11) NULL DEFAULT NULL COMMENT '对应文章的id',
  `fid` int(11) NULL DEFAULT NULL COMMENT '指向父评论的id',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '指向用户id',
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评论内容',
  `praise_count` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '点赞数量',
  `time` datetime(0) NULL DEFAULT NULL COMMENT '评论时间',
  `uuid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of community_response
-- ----------------------------
INSERT INTO `community_response` VALUES (1, 1, 0, '小名', '啦啦啦啦啦', '27', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (2, 1, 0, '打算接', '小蒜苗在哪里呀', '3', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (3, 1, 1, '大黑号子', '好害怕', '4', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (4, 1, 1, '小红', '爱学习的好孩子', '3', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (5, 1, 2, '一只耳', '我的耳朵啊', '3', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (6, 1, 3, '大狸子', '一个三', '1', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (7, 2, 0, '小黄狗', '五个六', '1', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (8, 3, 0, '白胖子', '我利弊', '1', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (9, 2, 7, '叮叮车', 'giao', '1', '2020-02-03 00:00:00', NULL);
INSERT INTO `community_response` VALUES (10, 3, 0, '评论测试', '路人甲', '0', '2020-12-04 17:36:12', NULL);
INSERT INTO `community_response` VALUES (11, 2, 7, '评论测试', '路人甲', '0', '2020-12-07 15:48:23', NULL);
INSERT INTO `community_response` VALUES (13, 2, 0, '测试员', '222222222222', '0', '2020-12-07 15:54:16', NULL);
INSERT INTO `community_response` VALUES (14, 1, 1, '测试员', '测试小名回复', '0', '2020-12-11 13:19:33', NULL);
INSERT INTO `community_response` VALUES (15, 1, 1, '测试员', '呜呜呜呜呜呜呜呜', '0', '2020-12-11 13:20:15', NULL);
INSERT INTO `community_response` VALUES (16, NULL, NULL, '测试员', 'wwwww ', '0', '2020-12-11 13:21:43', NULL);
INSERT INTO `community_response` VALUES (17, 1, 4, '测试员', '分明不爱学习', '0', '2020-12-11 13:28:04', NULL);
INSERT INTO `community_response` VALUES (18, 1, 2, '测试员', '哈哈哈哈', '0', '2020-12-11 13:58:44', NULL);
INSERT INTO `community_response` VALUES (19, 1, 0, '测试员', '作者厉害啊', '0', '2020-12-11 14:03:54', NULL);
INSERT INTO `community_response` VALUES (21, 1, 0, '测试员', '8J+YgfCfmIHwn5iB', '0', '2020-12-11 14:24:46', NULL);
INSERT INTO `community_response` VALUES (22, 1, 21, '测试员', '8J+YgzMzMw==', '0', '2020-12-11 14:25:08', NULL);
INSERT INTO `community_response` VALUES (23, 1, 0, '测试员', '5oiR6LCD5a6255S15Yqg54ix5ZOm6Kej6ICm5oiRd2Rham9haWpv', '0', '2020-12-11 14:31:50', NULL);
INSERT INTO `community_response` VALUES (24, 1, 0, '测试员', '我爱阿', '0', '2020-12-11 14:54:33', NULL);
INSERT INTO `community_response` VALUES (25, 1, 0, '测试员', '8J+YgQ==', '0', '2020-12-11 15:14:01', NULL);
INSERT INTO `community_response` VALUES (26, 1, 0, '测试员', '8J+YgA==', '0', '2020-12-11 15:15:11', NULL);
INSERT INTO `community_response` VALUES (27, 1, 3, '测试员', '8J+YhfCfmYN3d3d3d3d3', '0', '2020-12-11 15:39:41', NULL);
INSERT INTO `community_response` VALUES (28, 1, 2, '测试员', '8J+YhvCfmIY=', '3', '2020-12-11 16:30:59', NULL);
INSERT INTO `community_response` VALUES (29, 13, 0, '测试员', 'ZGE=', '0', '2020-12-15 15:29:29', NULL);
INSERT INTO `community_response` VALUES (30, 14, 0, '测试员', 'dw==', '0', '2020-12-15 17:27:30', NULL);
INSERT INTO `community_response` VALUES (31, 14, 0, '测试员', 'Mg==', '0', '2020-12-15 17:28:15', NULL);
INSERT INTO `community_response` VALUES (32, 14, 0, '测试员', 'Mg==', '0', '2020-12-15 17:29:28', NULL);
INSERT INTO `community_response` VALUES (33, 14, 30, '测试员', 'dw==', '0', '2020-12-15 17:30:00', NULL);
INSERT INTO `community_response` VALUES (34, 14, 30, '测试员', 'dw==', '0', '2020-12-15 17:30:52', NULL);
INSERT INTO `community_response` VALUES (35, 14, 30, '测试员', 'dw==', '0', '2020-12-15 17:32:04', NULL);
INSERT INTO `community_response` VALUES (36, 14, 35, '测试员', 'dw==', '0', '2020-12-15 17:32:47', NULL);
INSERT INTO `community_response` VALUES (37, 14, 31, '测试员', 'Mg==', '0', '2020-12-15 17:36:43', NULL);
INSERT INTO `community_response` VALUES (38, 14, 37, '测试员', 'Mg==', '0', '2020-12-15 17:37:15', NULL);
INSERT INTO `community_response` VALUES (39, 4, 0, '测试员', 'ZHdh', '0', '2021-01-12 09:06:32', '20210107162750874691');
INSERT INTO `community_response` VALUES (40, 4, 0, '测试员', '5LuK5aSp5piv5Liq5aW95pel5a2Q', '0', '2021-01-12 09:06:58', '20210107162750874691');
INSERT INTO `community_response` VALUES (41, 2, 0, '测试员', 'ZGE=', '0', '2021-02-08 16:50:07', '20210107162750874691');
...
-- Records of feedback
-- ----------------------------
INSERT INTO `feedback` VALUES (1, '路人甲', '路人甲爱吃酸辣粉');
INSERT INTO `feedback` VALUES (2, 'www', 'ww');
INSERT INTO `feedback` VALUES (3, 'w', 'w');
INSERT INTO `feedback` VALUES (4, '22', '333');
INSERT INTO `feedback` VALUES (5, '2', '2');

-- ----------------------------
-- Table structure for job_space_schedule
-- ----------------------------
DROP TABLE IF EXISTS `job_space_schedule`;
CREATE TABLE `job_space_schedule`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
-- ----------------------------
-- Records of job_space_schedule
-- ----------------------------
INSERT INTO `job_space_schedule` VALUES (11, '20210107162750874691', '2', '一会回去健身啊，健身结束', '2021-01-21 16:46:36', '2021-01-21 17:02:58', '2021-01-21 17:02:58');
INSERT INTO `job_space_schedule` VALUES (19, '20210107162750874691', '1', '整理前端进阶路线图\n', '2021-01-22 09:22:25', NULL, '2021-01-22 09:23:01');
INSERT INTO `job_space_schedule` VALUES (5, '20210107162750874691', '3', '今天吃面', '2021-01-21 15:03:47', NULL, NULL);
INSERT INTO `job_space_schedule` VALUES (6, '20210107162750874691', '2', '今天下午吃茄子炒西红柿', '2021-01-21 17:01:10', '2021-01-21 17:01:11', '2021-01-21 17:01:11');
INSERT INTO `job_space_schedule` VALUES (24, '20210107162750874691', '0', '今天成功部署nginx,egg,vue', '2021-02-08 16:46:07', NULL, NULL);
INSERT INTO `job_space_schedule` VALUES (23, '20210107162750874691', '0', '测试一下', '2021-02-08 16:45:44', NULL, NULL);
INSERT INTO `job_space_schedule` VALUES (21, '20210107162750874691', '1', '添加个人作品模块，程序，视频，音乐，文章，图片', '2021-01-22 10:10:02', NULL, NULL);
INSERT INTO `job_space_schedule` VALUES (22, '20210107162750874691', '2', '222', '2021-02-08 16:45:32', NULL, NULL);

-- ----------------------------
-- Table structure for job_space_science
-- ----------------------------
DROP TABLE IF EXISTS `job_space_science`;
CREATE TABLE `job_space_science`  (
  `id` int(11) NOT NULL,
  `pid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `content_c` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `content_e` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of job_space_science
-- ----------------------------
INSERT INTO `job_space_science` VALUES (1, '1', '原子', '原子是构成这个世界的最小微粒，这好比计算机世界所有的程序都是由机器码编译而成。', 'Atoms are the smallest particles that make up the world, as if all the programs in the computer world were compiled from machine code', NULL);
INSERT INTO `job_space_science` VALUES (2, '1', '生物', '生物由原子构成，在这个过程中产生了各种各样的生物，这些生物又根据他们的特性形成了种群。种群越来越多，最终形成了生物圈。\r\n   在计算机的世界中也是如此演变，由机器源码逐渐产生了各种技术语言，这好比生物。这些技术逐渐演变形成了各大技术社区框架，在电子世界拥有自己的领地。最终由这些技术栈形成了计算机网络世界。', ' Living things are made up of atoms, and in the process give rise to a variety of living things, which in turn form populations according to their characteristics.The population grew and eventually formed the biosphere.\r\nIn the computer world, too, the source code from the machine has gradually produced a variety of technical languages, like biology.These technologies have evolved into a framework of technology communities that have their own place in the electronic world.Eventually, these stacks formed the world of computer networks.', NULL);
INSERT INTO `job_space_science` VALUES (3, '1', '栖息地', '栖息地是生物赖以生存的空间，离开这个空间它们可能就无法存活。在电子网络的世界这好比操作系统，为计算机世界提供了栖息地。', 'Habitat is the space in which organisms live, and without it they may not be able to survive.In the world of electronic networks this is like an operating system, which provides a habitat for the computer world.', NULL);
INSERT INTO `job_space_science` VALUES (4, '1', '信息传输', '这个世界拥有各种传输信息的手段，信号塔，雷达，电报等等。电子网络世界中也如此类同，彼此直接需要信息的传输，这些规则统称网络协议。', 'The world has all kinds of means of transmitting information, tower, radar, telegraph and so on.In the electronic network world is also similar, each other directly need the transmission of information, these rules collectively known as the network protocol.', NULL);
INSERT INTO `job_space_science` VALUES (5, '1', '信息存储', '现实世界的资料信息的记录存储自古以来都是以文字的形式，到如今出现了影音图像等等。电子世界的信息存储等于数据库等的记录存储。', 'The recording and storage of real world information has been in the form of text since ancient times, until now there have been audio-visual images and so on.Information storage in the electronic world is equal to record storage in databases and so on.', NULL);
INSERT INTO `job_space_science` VALUES (6, '1', '程序员', '<p>在这个世界有一部分人通过操作代码的形式来操作或者制造程序。计算机工程师对于电子世界来说好比穿越者，可以影响到电子世界。以前很喜欢数码宝贝，这里用来类比。</p>\r\n  <p> 幼年期 ：会简单使用计算机代码</p>\r\n   <p> 成熟期 ：能够编写成熟应用</p>\r\n   <p> 完全体 ：全栈工程师</p>\r\n   <p> 究极体 ：架构师</p>\r\n  <p>  超究极体 ：？？？</p>', '<p> There are people in this world who operate or make programs in the form of operating code.Computer engineers to the electronic world is like a traveler, can influence the electronic world.I used to love digimon, so that\'s an analogy.</p>\r\n   <p> infancy ：Simple use of computer code</p>\r\n   <p> mature period ： Ability to write mature applications</p>\r\n   <p> complete body ： Full stack engineer</p>\r\n   <p>The ultimate body ：architect</p>\r\n   <p> The super ultimate body ： ???</p>', NULL);
INSERT INTO `job_space_science` VALUES (7, '1', 'BUG', ' <p>我们的世界经常会发生各种各样的灾难，有些是自然的，有些是人为的，发生这些后我们都需要尽力去弥补。电子世界有一种名为bug的数码流，它的出现总会给电子世界带来各种各样的影响和灾难，这里同样用数码宝贝来类比。</p>\r\n    <p>幼年期 ：代码世界出现事故，但没有产生什么影响</p>\r\n   <p> 成熟期 ：导致一部分功能失效，不会给整体带来影响</p>\r\n    <p>完全体 ：软件崩溃</p>\r\n   <p> 究极体 ：系统崩溃</p>\r\n    <p>超究极体 ：？？？</p>', '<p>Our world is full of disasters, some natural, some man-made, and we have to make up for them.The digital world has a digital stream called bug, the emergence of which will always bring a variety of effects and disasters to the electronic world, the digital world analogy is also used here.</p>\r\n    <p> infancy ：An accident in the code world, but no impact</p>\r\n   <p>  mature period ： Failure of some functions will not affect the whole</p>\r\n    <p> complete body ： Software crashes</p>\r\n   <p> The ultimate body ：A system crash</p>\r\n    <p> The super ultimate body ： ???</p>', NULL);
INSERT INTO `job_space_science` VALUES (8, '1', '电子设备', '在我们的世界联通网络的主要工具是电子设备，分为手机，电脑两大类。对于电子世界来说，计算机好比一个时光之门可以让另一个世界的人来到这个世界。', 'In our world, the main tools of network connectivity are electronic devices, divided into mobile phones and computers.To the electronic world, the computer is like a time portal that can bring people from another world into this world.', NULL);
INSERT INTO `job_space_science` VALUES (9, '1', '人工智能', '人工智能，机器人等在我们的世界逐渐出现，为我们的生活和发展带来了极大的体验。同时计算机世界这些人工智能成为了大大小小的领主，统治一块电子领域。', 'Artificial intelligence, robots and so on gradually appear in our world, bringing great experience to our life and development.At the same time, these artificial intelligences in the computer world became lords large and small, dominating an electronic realm.', NULL);
INSERT INTO `job_space_science` VALUES (10, '1', '计算机软件', '计算机软件，既然计算机是前往电子世界的时光门，那么我们怎么前往呢。就这样各种计算机软件逐步诞生，有些用来观赏电子世界，有些用来建设电子世界，有些用来前往电子世界，甚至有些用来攻击电子世界，他们相当于电子世界的各种工具。', 'Computer software. Since computers are the time gate to the electronic world, how can we get there?In this way, a variety of computer software was gradually born, some used to watch the electronic world, some used to build the electronic world, some used to go to the electronic world, and even some used to attack the electronic world, they are equivalent to the electronic world of various tools.', NULL);
INSERT INTO `job_space_science` VALUES (11, '1', '生存资源', '我们的世界的存活需要各种能源，阳光，水等各种资源。而在电子世界只需要一种资源，电力。', 'The survival of our world needs all kinds of energy, sunlight, water and other resources.And in the electronic world you only need one resource, electricity.', NULL);
INSERT INTO `job_space_science` VALUES (12, '1', '住所', '现实世界中每个生物都需要他们的住所，来保证它们的生存。电子世界中，电子生物们也拥有他们的住所，例如服务器，硬盘等等。', 'Every living thing in the real world needs a place to live, to keep them alive.In the electronic world, electronic creatures also own their homes, such as servers, hard drives, and so on.', NULL);
INSERT INTO `job_space_science` VALUES (13, '1', '神明', '???', '???', NULL);
...
-- Records of tools
-- ----------------------------
INSERT INTO `tools` VALUES (1, 'MDN', '提供 Web 技术文档，学习 Web 开发的最佳实践', '语言文档和规范', 'https://developer.mozilla.org/zh-CN/docs/Web', 'https://developer.mozilla.org/static/img/favicon144.e7e21ca263ca.png');
INSERT INTO `tools` VALUES (10, 'ECMAScript', 'ECMAScript 2018 标准', '语言文档和规范', 'https://ecma262.docschina.org/', 'https://cdn.docschina.org/home/logo/ecma.svg');
INSERT INTO `tools` VALUES (11, 'GraphQL', '一种用于API的查询语言', '语言文档和规范', 'https://graphql.cn/', 'https://cdn.docschina.org/home/logo/graphql.svg');
INSERT INTO `tools` VALUES (12, 'Vant', '移动端vue组件库', 'Vue', 'https://youzan.github.io/vant/#/zh-CN/', 'https://cdn.docschina.org/home/logo/vant.png');
INSERT INTO `tools` VALUES (13, 'Weex', '基于Vue的移动端跨平台UI', 'Vue', 'https://weex.apache.org/', 'https://cdn.docschina.org/home/logo/weex.svg');
INSERT INTO `tools` VALUES (14, 'React Native', '基于 React 的移动端跨平台 UI', 'React', 'https://reactnative.cn/', 'https://cdn.docschina.org/home/logo/react.svg');
INSERT INTO `tools` VALUES (15, 'Iconfont', '阿里巴巴矢量图标库', '设计', 'https://www.iconfont.cn/', 'http://img.alicdn.com/tps/i4/TB1_oz6GVXXXXaFXpXXJDFnIXXX-64-64.ico');
INSERT INTO `tools` VALUES (16, '掘金', '一个帮助开发者成长的社区', '论坛', 'https://juejin.cn/frontend', 'https://b-gold-cdn.xitu.io/favicons/v2/apple-touch-icon.png');
INSERT INTO `tools` VALUES (17, '阿里云', '上云就上阿里云', '服务器', 'https://www.aliyun.com/', 'https://img.alicdn.com/tfs/TB1_ZXuNcfpK1RjSZFOXXa6nFXa-32-32.ico');
INSERT INTO `tools` VALUES (18, '程序员在线工具', '一款便利的程序员在线工具', '工具', 'http://www.ofmonkey.com/front/rem', 'http://www.ofmonkey.com/images/monkey.ico');
INSERT INTO `tools` VALUES (19, '菜鸟教程', '代码学习网站', '教程', 'https://www.runoob.com/js/js-tutorial.html', 'https://static.runoob.com/images/favicon.ico');
INSERT INTO `tools` VALUES (20, 'Cycle.js', '一个函数式和响应式的 JavaScript 框架，编写可观测代码', '函数式编程', 'http://cyclejs.cn/', 'http://cyclejs.cn/img/cyclejs_logo.svg');
INSERT INTO `tools` VALUES (21, 'jquery', '高效精简强大的工具库', 'Utils工具', 'https://www.jquery123.com/', 'https://cdn.docschina.org/home/logo/jquery.svg');
INSERT INTO `tools` VALUES (22, 'Eslint', '可组装的、用于 JavaScript 和 JSX 的代码检查工具', '代码风格检查', 'https://cn.eslint.org/', 'https://cdn.docschina.org/home/logo/eslint.svg');
INSERT INTO `tools` VALUES (23, 'egg', '为企业级框架和应用而生', 'Node.js', 'https://eggjs.org/zh-cn/', 'https://eggjs.org/images/favicon.png');
INSERT INTO `tools` VALUES (24, 'Jest', 'Facebook 开发的零配置测试平台，让代码库更加稳定和健壮', '测试工具', 'https://jest.docschina.org/', 'https://cdn.docschina.org/home/logo/jest.png');
INSERT INTO `tools` VALUES (25, 'webpack', '用于现代 JavaScript 应用程序的静态模块打包工具', '编译构建', 'https://webpack.docschina.org/', 'https://cdn.docschina.org/home/logo/webpack-offical.svg');
INSERT INTO `tools` VALUES (26, 'EJS', 'JavaScript 模板引擎', '模板引擎', 'https://ejs.co/', 'https://ejs.co/favicon.svg');
INSERT INTO `tools` VALUES (27, 'Mobx', '简单、可扩展的状态管理', '状态管理', 'https://cn.mobx.js.org/', 'https://cdn.docschina.org/home/logo/mobx.png');
INSERT INTO `tools` VALUES (28, 'Remax', 'Remax 将 React 运行在小程序环境中，让你可以使用完整的 React 进行小程序开发', '小程序', 'https://remaxjs.org/', 'https://gw.alipayobjects.com/mdn/rms_b5fcc5/afts/img/A*1NHAQYduQiQAAAAAAAAAAABkARQnAQ');
INSERT INTO `tools` VALUES (29, 'Sass', 'Sass 是 CSS 的一个扩展，它使 CSS 的使用起来更加优雅和强大。', 'css', 'https://www.sass.hk/', 'https://cdn.docschina.org/home/logo/sass.svg');
INSERT INTO `tools` VALUES (30, 'Tree.js', 'JavaScript 3d 库', '可视化工具', 'https://threejs.docschina.org/#manual/introduction/Creating-a-scene', 'https://cdn.docschina.org/home/logo/threejs.png');
INSERT INTO `tools` VALUES (31, 'thinkphp', 'php开源框架', '后端', 'http://www.thinkphp.cn/', 'https://static.runoob.com/images/favicon.ico');
INSERT INTO `tools` VALUES (32, 'vue', '渐进式 JavaScript 框架', '前端', 'https://vuejs.org/', 'https://cn.vuejs.org/images/logo.png');
INSERT INTO `tools` VALUES (33, 'react', '用于构建用户界面的 JavaScript 库', '前端', 'https://react.docschina.org/', 'https://cdn.docschina.org/home/logo/react.svg');

-- ----------------------------
-- Table structure for tools_option
-- ----------------------------
DROP TABLE IF EXISTS `tools_option`;
CREATE TABLE `tools_option`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '1代表职业工具模块，2代表社会服务模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tools_option
-- ----------------------------
INSERT INTO `tools_option` VALUES (1, '前端', '1');
INSERT INTO `tools_option` VALUES (2, '后端', '1');
INSERT INTO `tools_option` VALUES (3, '设计', '1');
INSERT INTO `tools_option` VALUES (4, '论坛', '1');
INSERT INTO `tools_option` VALUES (5, '服务器', '1');
INSERT INTO `tools_option` VALUES (6, '工具', '1');
INSERT INTO `tools_option` VALUES (7, '教程', '1');
INSERT INTO `tools_option` VALUES (8, '其他', '1');
INSERT INTO `tools_option` VALUES (9, '语言文档和规范', '1');
INSERT INTO `tools_option` VALUES (10, '函数式编程', '1');
INSERT INTO `tools_option` VALUES (11, 'Vue', '1');
INSERT INTO `tools_option` VALUES (12, 'React', '1');
INSERT INTO `tools_option` VALUES (13, 'Utils工具', '1');
INSERT INTO `tools_option` VALUES (14, '代码风格检查', '1');
INSERT INTO `tools_option` VALUES (15, 'Node.js', '1');
INSERT INTO `tools_option` VALUES (16, '测试工具', '1');
INSERT INTO `tools_option` VALUES (17, '编译构建', '1');
INSERT INTO `tools_option` VALUES (18, '模板引擎', '1');
INSERT INTO `tools_option` VALUES (19, '状态管理', '1');
INSERT INTO `tools_option` VALUES (20, '小程序', '1');
INSERT INTO `tools_option` VALUES (21, 'css', '1');
INSERT INTO `tools_option` VALUES (22, '可视化工具', '1');
INSERT INTO `tools_option` VALUES (23, '社保', '2');
INSERT INTO `tools_option` VALUES (24, '公积金', '2');

-- ----------------------------
-- Table structure for tools_social
-- ----------------------------
DROP TABLE IF EXISTS `tools_social`;
CREATE TABLE `tools_social`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签名',
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签描述',
...
-- ----------------------------
-- Records of tools_social
-- ----------------------------
INSERT INTO `tools_social` VALUES (34, '公积金管理局', '陕西省住房资金管理中心官网', '公积金', 'https://www.sxgjj.com/', 'http://www.kaiyi.xyz/001/MyWorld/images/tools/social/gongjijin.png', '陕西省,西安市');
INSERT INTO `tools_social` VALUES (35, '社会保障局', '陕西省西安市社会保障局官方网站', '社保', 'http://xahrss.xa.gov.cn/', 'http://www.kaiyi.xyz/001/MyWorld/images/tools/social/shebao.png', '西安市');
INSERT INTO `tools_social` VALUES (36, '测试用', '陕西省西安市社会保障局官方网站', '社保', 'http://xahrss.xa.gov.cn/', 'http://www.kaiyi.xyz/001/MyWorld/images/tools/social/shebao.png', '西安市');
...
CREATE TABLE `user`  (
  ...
  `uuid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户id',
  ...
  `user_job` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '职业',
  `user_number` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '账号',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (19, '20210107161747668858', '游客0.1604号', '123456', NULL, '18700692588', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (20, '20210107162420126445', '游客0.26745515583164736号', '123456', NULL, '18700692511', NULL, NULL, NULL, NULL, '2021-01-07 16:24:20', '2021-01-07 16:24:20');
INSERT INTO `user` VALUES (21, '20210107162750874691', '座头鲸', '123456', '1', '18700692544', 'http://127.0.0.1:7001/public/uploads/2021/02/09/1612834360351171.jpeg', '长涛小贷', '前端工程师', '啦啦啦', '2021-01-07 16:27:51', '2021-01-07 16:27:51');
INSERT INTO `user` VALUES (22, '20210119141858711399', '游客0.2937', '', '', '', NULL, NULL, NULL, NULL, '2021-01-19 14:18:59', '2021-01-19 14:18:59');

-- ----------------------------
-- Table structure for works_resume
-- ----------------------------
DROP TABLE IF EXISTS `works_resume`;
CREATE TABLE `works_resume`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `expJob` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '期望职位',
  `livePlace` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '期望地点',
  `expIncome` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '期望薪资',
  `skill` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '技能',
  `interest` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '爱好',
  `myIntroduce` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '自我介绍',
  `jobExp` varchar(2550) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '工作经历',
  `projectExp` varchar(2550) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目经历',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of works_resume
-- ----------------------------
INSERT INTO `works_resume` VALUES (1, '20210107162750874691', '1', '阿和变身ss2', '男', '厨师', '18700665544', '870063800', '870063800@qq.com', 'AH870063800', '厨师', '大阪', '？', '哈哈哈', '调酒，拉花', '在字节的日常业务开发中，我需要将不同的业务组件挂载在一个不属于我们接管的平台页面中，由于每个业务组件都有各自不同的挂载位置和时机，并且都可以看做一个单独的 React 应用，所以我们用 Webpack 进行多入口打包，打出多个 React 应用，然后在这个页面通过引入 sdk 的方式挂载业务组件\n\n作者：弹铁蛋同学\n链接：https://juejin.cn/post/6901133072561864712\n来源：掘金\n著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。', '', '');
INSERT INTO `works_resume` VALUES (2, '1', NULL, '八神太一', '男', '宇航员', '18700110011', '106000111', '106000111@qq.com', 'TY106000111', '宇航员', '东京', '？', 'wwww', '修理，制造', '每台计算机上只需要配置一次，程序升级时会保留配置信息。你可以在任何时候再次通过运行命令来修改它们。 Git 自带一个 gitconfig 的工具来帮助设置控制 Git 外观和行为的配置变量。这些变量存储在三个不同的位置：', '', '');
INSERT INTO `works_resume` VALUES (36, '20210107162750874691', NULL, '大王wwww', '男', '213', '18700692566', '870063810', '870063810@qq.com', '18700692544', '2da', 'da', '21dad', 'daad', 'daad', 'daad', '', '');
INSERT INTO `works_resume` VALUES (40, '20210107162750874691', NULL, '222', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `works_resume` VALUES (37, '20210107162750874691', NULL, '2222222222222222', '男', '22222222222', 'wwwwwwwwwwwww', 'w22222222222222', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `works_resume` VALUES (38, '20210107162750874691', NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `works_resume` VALUES (39, '20210107162750874691', NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');

-- ----------------------------
-- Table structure for works_resume_jobexp
-- ----------------------------
DROP TABLE IF EXISTS `works_resume_jobexp`;
CREATE TABLE `works_resume_jobexp`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of works_resume_jobexp
-- ----------------------------
INSERT INTO `works_resume_jobexp` VALUES (2, 2, 'NSA', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-12-01 13:22:50', '2020-12-01 13:22:52');
INSERT INTO `works_resume_jobexp` VALUES (3, 2, '苹果', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-12-01 13:22:56', '2020-12-01 13:22:58');
INSERT INTO `works_resume_jobexp` VALUES (89, 40, '', '', NULL, NULL);
INSERT INTO `works_resume_jobexp` VALUES (66, 36, 'dda', 'dadaa', '2021-01-19 16:00:00', '2021-01-12 16:00:00');
INSERT INTO `works_resume_jobexp` VALUES (68, 37, '', '', '1970-01-01 00:00:00', '1970-01-01 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (69, 38, '', '', NULL, NULL);
INSERT INTO `works_resume_jobexp` VALUES (70, 39, '', '', NULL, NULL);
INSERT INTO `works_resume_jobexp` VALUES (97, 1, 'adw', 'dwadaw', '1969-12-28 00:00:00', '1969-12-28 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (98, 1, '哑鼓小学', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-11-25 00:00:00', '2020-11-25 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (96, 1, '科技岛', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-11-25 00:00:00', '2020-11-25 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (101, 1, '哑鼓小学', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-11-25 00:00:00', '2020-11-25 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (99, 1, '沣西中学', '大啊大大', '1969-12-27 00:00:00', '1969-12-27 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (100, 1, '沣西中学', '大啊大大', '1969-12-27 00:00:00', '1969-12-27 00:00:00');
INSERT INTO `works_resume_jobexp` VALUES (48, 2, '苹果', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-12-01 05:22:56', '2020-12-01 05:22:58');
INSERT INTO `works_resume_jobexp` VALUES (47, 2, 'NSA', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-12-01 05:22:50', '2020-12-01 05:22:52');

-- ----------------------------
-- Table structure for works_resume_projectexp
-- ----------------------------
DROP TABLE IF EXISTS `works_resume_projectexp`;
CREATE TABLE `works_resume_projectexp`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) UNSIGNED NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
...
-- ----------------------------
-- Records of works_resume_projectexp
-- ----------------------------
INSERT INTO `works_resume_projectexp` VALUES (72, 1, '打到你', '名刀', '大大王', '1969-12-27 00:00:00', '1969-12-27 00:00:00');
INSERT INTO `works_resume_projectexp` VALUES (73, 1, '欧莱雅1号', '欧莱雅33333333333333', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-11-25 00:00:00', '2020-11-25 00:00:00');
INSERT INTO `works_resume_projectexp` VALUES (67, 40, '', '', '', NULL, NULL);
INSERT INTO `works_resume_projectexp` VALUES (71, 1, '打到你', '名刀', '大大王', '1969-12-27 00:00:00', '1969-12-27 00:00:00');
INSERT INTO `works_resume_projectexp` VALUES (53, 36, 'dwawda', 'dad', 'dwadaw', '2021-01-20 16:00:00', '2021-01-19 16:00:00');
INSERT INTO `works_resume_projectexp` VALUES (55, 37, '', '', '', '1970-01-01 00:00:00', '1970-01-01 00:00:00');
INSERT INTO `works_resume_projectexp` VALUES (56, 38, '', '', '', NULL, NULL);
INSERT INTO `works_resume_projectexp` VALUES (57, 39, '', '', '', NULL, NULL);
INSERT INTO `works_resume_projectexp` VALUES (2, 2, '欧莱雅1号', '欧莱雅', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-12-01 13:22:42', '2020-12-01 13:22:46');
INSERT INTO `works_resume_projectexp` VALUES (39, 2, '欧莱雅1号', '欧莱雅', 'UNION 运算符通过组合其他两个结果表（例如 TABLE1 和 TABLE2）并消去表中任何重复行而派生出一个结果表。当 ALL 随 UNION 一起使用时（即 UNION ALL），不消除重复行。两种情况下，派生表的每一行不是来自 TABLE1 就是来自 TABLE2。 ', '2020-12-01 05:22:42', '2020-12-01 05:22:46');
